  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full " id="home"> 
      <div className=" py-2 flex-1 flex flex-col items-start  justify-center gap-6">
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]"> A brief description about the food deliver app
      ...
      <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 flex-wrap gap-4">
        {heroData && heroData.map(n=>(
          ...
          <p className="text-sm font-semibold text-headingColor"> ₹ <span className="text-xs text-red-600 font-semibold ">{n.price}</span>
